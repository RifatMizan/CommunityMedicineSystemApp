<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SendMedicine.aspx.cs" Inherits="CommunityMedicineSystemApp.UI.SendMedicine" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" ng-app="myApp">
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-offset-3" style="margin-top: 10px;">
                    <div class="form-horizontal" ng-controller="myController">
